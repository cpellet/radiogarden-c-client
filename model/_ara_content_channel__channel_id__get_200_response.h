/*
 * _ara_content_channel__channel_id__get_200_response.h
 *
 * 
 */

#ifndef __ara_content_channel__channel_id__get_200_response_H_
#define __ara_content_channel__channel_id__get_200_response_H_
...
typedef struct _ara_content_channel__channel_id__get_200_response_t _ara_content_channel__channel_id__get_200_response_t;

#include "channel.h"



typedef struct _ara_content_channel__channel_id__get_200_response_t {
    int api_version; //numeric
    char *version; // string
    struct channel_t *data; //model
...
#endif /* __ara_content_channel__channel_id__get_200_response_H_ */
